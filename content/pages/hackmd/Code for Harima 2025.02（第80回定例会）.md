...
- 場所: [加古川びぃぷらす](https://bb-beplus.net/) /
  [オンライン](https://meet.jit.si/moderated/2e1dddcb737659dfaf7e569c158bbd3aa7acf95eedec00441b0e87ac4db731e1)
...
- 展示ブース（出展者と展示内容リスト）
  ...
  - OpenStreetMap
    Japanブースに１日います。　 *坂ノ下さんは、WikidateとOpentreetmapを絡めてお話していた。
    <https://event.ospn.jp/osc2025-osaka/session/1963430> 　 *
    Wikidateってなに？びぃぷらすの韓国語のページと日本語のページができました。説明される対象が同一であることを示す番号がふられる。
...
- JA:Wikidata - OpenStreetMap Wiki:
  <https://wiki.openstreetmap.org/wiki/JA:Wikidata>
...
テーマは「観光」アドバイザーからは、対象をできるだけ小さくするいいと言われていて、おじいちゃんおばあちゃんにしぼるとか、稲美町全体は大きすぎるのではと言われた。 *(遊具のある公園マップ(<https://armd-02.github.io/Playgrounds/?node/11390856787&category=-#19/34.7651439/134.8622103>)  *
